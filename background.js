    ...
    chrome.contextMenus.removeAll(() => {
        ...
        chrome.contextMenus.create({
            ...
            if (chrome.runtime.lastError) {
                console.error("Error creating Play TTS menu:", chrome.runtime.lastError);
            } else {
        ...
        chrome.contextMenus.create({
            ...
            if (chrome.runtime.lastError) {
                console.error("Error creating Voices submenu:", chrome.runtime.lastError);
            } else {
            ...
            .then(data => {
                ...
                voices.forEach(voice => {
                    ...
                    chrome.contextMenus.create({
                        ...
                        if (chrome.runtime.lastError) {
                            console.error(`Error creating submenu for voice "${voice}" with ID "${voiceId}":`, chrome.runtime.lastError);
                        } else {
...
chrome.contextMenus.onClicked.addListener((info, tab) => {
        ...
        console.log(`Selected voice ID: ${info.menuItemId}`);
            const selectedVoice = info.menuItemId;
        ...
        if (selectionText) {
            chrome.storage.sync.get(["ip", "port", "characterVoice", "language"], (data) => {
              ...
              //  const characterVoice = data.characterVoice || "female_01.wav";
                const characterVoice = selectedVoice || "female_01.wav";
